...
for(id in 1:2) { 
  name_of_sim <- paste("~/Documents/RDirectory/clusterpval-assumptions/simulation-results/A-1type1-est-n", n, "-q", nfeat, "-pt", id, ".Rdata", sep="")
...
ev_cat$len[grep("len_8", ev_cat$Model)] <- 8
...
ggsave(combined + plot_layout(nrow=1, guides = "collect"), file="~/Documents/RDirectory/clusterpval-assumptions/figures/FigureS1A1.pdf", 
