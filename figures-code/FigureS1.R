...
average_filter <- as.data.frame(average %>% group_by(len))
centroid_filter <- as.data.frame(centroid %>% group_by(len))
single_filter <- as.data.frame(single %>% group_by(len))
complete_filter <- as.data.frame(complete %>% group_by(len))
